			...
			CDataExam dbo=new CDataExam();
						if( dbo.Connect()){
						 ...
						 int tipo_examen= valid.ConvertEntero(valid.ValidarRequest(request.getParameter("tipo_examen")));
												...
												data+="<row id='"+temp.getIdcita()+"'><cell><![CDATA[<input type='checkbox'  name='deleteactivity' class='dele_activity' value='"+temp.getIdcita()+"' />]]></cell><cell><![CDATA["+temp.getIdcita()+"]]></cell><cell><![CDATA["+temp.getFormatoFechaddmmyy(temp.getFecha())+"]]></cell><cell><![CDATA["+temp.getFormatoFechaDes(temp.getFecha())+"]]></cell><cell><![CDATA["+temp.getFormatoFechahhmm(temp.getHora_inicio())+"]]></cell><cell><![CDATA["+temp.getTipo_examenD()+"]]></cell><cell><![CDATA["+temp.getCupo()+"]]></cell></row>";	 
