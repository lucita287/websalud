...
public class VerificaDatosRyELocator extends org.apache.axis.client.Service implements gt.edu.usac.rye.nusoap.VerificaDatosRyE {
    ...
    private java.lang.String VerificaDatosRyEPort_address = "http://www.registro.usac.edu.gt/WS/verificadatosRyEWebService2.php";
    ...
    public gt.edu.usac.rye.nusoap.VerificaDatosRyEPortType getVerificaDatosRyEPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            gt.edu.usac.rye.nusoap.VerificaDatosRyEBindingStub _stub = new gt.edu.usac.rye.nusoap.VerificaDatosRyEBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (gt.edu.usac.rye.nusoap.VerificaDatosRyEPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                gt.edu.usac.rye.nusoap.VerificaDatosRyEBindingStub _stub = new gt.edu.usac.rye.nusoap.VerificaDatosRyEBindingStub(new java.net.URL(VerificaDatosRyEPort_address), this);
                _stub.setPortName(getVerificaDatosRyEPortWSDDServiceName());
                return _stub;
            }
        }
