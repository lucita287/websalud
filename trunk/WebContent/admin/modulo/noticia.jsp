...
%>
			...
			<table id="flex1" style="display:none"></table>		
					<table width="80%" CELLSPACING="8">
								...
								<BR/>	
									<div class="centerd">
										<a href="#validacion_imagen"  class="ui-state-default ui-corner-all button-new"> <img  width="24px"  height="24px" src="../images/add.png" /> Nuevo</a>
			  ...
			  $(document).ready(function () {
				  ...
				  $("#flex1").flexigrid
					({
						...
						{ display: 'idnoticia', name: 'idnoticia', width: 40, sortable: true, align: 'left' },
